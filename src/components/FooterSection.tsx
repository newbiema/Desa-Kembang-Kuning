    ...
    <footer className="bg-green-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Tentang Desa */}
          <div>
            <h3 className="text-xl font-bold mb-4">Desa Kembang Kuning</h3>
            <p className="mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-yellow-300">Beranda</a></li>
              <li><a href="#" className="hover:text-yellow-300">Profil Desa</a></li>
              <li><a href="#" className="hover:text-yellow-300">Pemerintahan</a></li>
              <li><a href="#" className="hover:text-yellow-300">Potensi Desa</a></li>
              <li><a href="#" className="hover:text-yellow-300">Galeri</a></li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="mb-2 flex items-start">
                ...
                Desa Kembang Kuning, Kec. [Nama Kecamatan], Kab. Lombok Timur, Nusa Tenggara Barat
              </p>
